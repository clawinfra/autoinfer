...
def run_experiment(
    ...
    # TurboQuant asymmetric KV: K and V can have different quantisation
    # Google finding: K is queried more → K deserves higher precision than V
    kv_type_v = params.get("kv_type_v", "same")
    if kv_type_v == "same" or kv_type_v is None:
        type_v = type_k  # symmetric (default)
    else:
        type_v = kv_type_v  # asymmetric e.g. K=q8_0, V=q4_0
